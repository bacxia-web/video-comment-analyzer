...
test("manifest uses minimized install-time permissions", () => {
  ...
  assert.equal(manifest.options_ui.page, "preferences.html");
...
test("unified release includes setup, platform scope, install instructions and privacy", () => {
  ...
  for (const host of ["https://www.bilibili.com/*", "https://www.xiaohongshu.com/*", "https://xueqiu.com/*"])
  ...
  assert.match(read("setup.js"), /showModal/);
